...
export default function Contacts() {
  ...
  useEffect(()=>{ if(preselected && !form.comment){ setForm(s=>({...s, comment:`Цікавить пакет: ${preselected}`})); } /* eslint-disable-next-line */ },[]);
  ...
  return (
    <section className="contact">
      <div className="container contact__inner">
        ...
        {/* COMBO: одна картка на всю ширину, всередині flex-дві колонки */}
        <div className="combo card">
          ...
          <aside className="visual">
            <div className="visual__media">
              <img src={contactHero} alt="Студентка на онлайн-уроці англійської" className="visual__img" loading="eager" />
